      ...
      >
        <div className="row g-0" style={{ minHeight: "100vh" }}>
          ...
          <div className="col-12 col-lg-6 m-auto bg-dark d-flex align-items-center     justify-content-center py-5 px-3">
            <div
              className="w-100"
              style={{ maxWidth: "480px", marginTop: "10rem" }}
            >
              <div className="bg-black  border border-secondary rounded-4 shadow-lg p-4 p-sm-5">
                ...
                <div className="text-center mb-4">
                  ...
                  <p className="text-secondary small mb-0">
                    Apna account abhi banao — bilkul free!
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="input-group">
                      <span
                        className="input-group-text bg-secondary bg-opacity-25 border-secondary text-primary"
                        style={{ width: "42px" }}
                      >
                  ...
                  <div className="mb-3">
                    ...
                    <div className="input-group">
                      <span
                        className="input-group-text bg-secondary bg-opacity-25 border-secondary text-primary align-items-start pt-2"
                        style={{ width: "42px" }}
                      >
