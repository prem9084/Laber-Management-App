    ...
    <div className="container-fluid clearfix">
      ...
      <div className="right-content float-right">
        ...
        <ul className="navigation-box">
          ...
          <li>
            <a href="solutions.html">Our Solution</a>
            <ul className="sub-menu">
          ...
          <li>
            <a href="how-work.html">How We Works</a>
            <ul className="sub-menu">
      ...
      <div>
        <section className="hidden-sidebar side-navigation">
          <span className="close-button side-navigation-close-btn fa fa-close" />
          {/* /.close-button */}
          <div className="sidebar-content">
            <img
              src="assets/images/hidden-bar-image-1-1.jpg"
              alt="Awesome Image"
            />
            <p>
              Prefer speaking with a human to filling out a form? Call our
              corporate office and we will connect you with a team member <br />{" "}
              who can help.
            </p>
            ...
            {/* /.contact-info */}
            <a href="#" className="download-btn one">
              <i className="fa fa-file-pdf-o" /> Looking for your W-2?
            </a>
            <a href="#" className="download-btn two">
              <i className="fa fa-building-o" /> Payonline Sales Offices
            </a>
          </div>
        </section>
